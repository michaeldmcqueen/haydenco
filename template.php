...
function hayden_preprocess_page(&$variables) {
  if (isset($variables['node']) && $variables['node']->type == 'projects') {
    drupal_add_css(drupal_get_path('theme', 'hayden') . '/flexslider/flexslider.css');
    drupal_add_js(drupal_get_path('theme', 'hayden') . '/flexslider/jquery.flexslider-min.js');
    drupal_add_js(drupal_get_path('theme', 'hayden') . '/flexslider/script.js');
    $variables['scripts'] = drupal_get_js();
  }
}
 
function chloe_preprocess_maintenance_page(&$vars, $hook) {
